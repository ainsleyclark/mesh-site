<!-- =====================
    Header
    ===================== -->
<header class="primary d-flex align-items-center {{ $activePage }}">
    <div class="container-fullwidth px-tab-4">
        <div class="row">
            <div class="col-6">
                <a class="d-flex align-items-center logo-cont" href="/">
                    <div class="logo-cont d-flex align-items-center">
                        <img class="logo" src="/assets/svg/meshlogo.svg" alt="mesh Logo">
                    </div>
                    <div class="text-cont d-none d-tab-block c-white">
                        <h3>meshCSS</h3>
                    </div>
                </a>
            </div>
            <!-- //! d none here for mobile -->
            <div class="col-6 align-items-center justify-content-end d-none d-tab-flex">        
                <nav class="primary">
                    <ul class="d-flex align-items-center my-0 t-uppercase">
                        ...
                        <a class="ml-3" href="/documentation/getting-started/introduction">
                            <button class="btn btn-rounded btn-outline btn-white btn-icon download">Download
