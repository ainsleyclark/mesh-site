...
<article class="section-scroll" id="variables">
    ...
    <div class="table-scroll">
        <table class="table">
                ...
                <tbody>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$pagination-enable-shadow: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables pagination shadow of the active element.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$pagination-rounded: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables rounded pagination, use false for square.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$pagination-height: 30px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Pagination container height in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$pagination-text-color: #999;</code></pre></td>
                        <td>Color</td>
                        <td>Pagination text color.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$pagination-active-color: color('primary');</code></pre></td>
                        <td>Color</td>
                        <td>Pagination active class color, by default it uses primary from the color palette.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$pagination-font-size: 12px;</code></pre></td>
                        <td>Pixel/em/rem</td>
