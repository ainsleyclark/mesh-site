...
<article class="section-scroll" id="variables">
    ...
    <div class="table-scroll">
        <table class="table">
                ...
                <tbody>
                    <tr>
                        <td style="vertical-align: middle;"><pre class="variables highlight"><code class="scss">$list-background-color: #fff;</code></pre></td>
                        <td>Color</td>
                        <td>The default background color of the list component.</td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle;"><pre class="variables highlight"><code class="scss">$list-border-color: #ddd;</code></pre></td>
                        <td>Color</td>
                        <td>The border color of the list component.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$list-active-color: color('primary');</code></pre></td>
                        <td>Color</td>
                        <td>The active (user selected) color of the list component, the default takes the primary color from the color palette.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$list-disabled-color: #999;</code></pre></td>
                        <td>Color</td>
