...
<article class="section-scroll" id="variables">
    ...
    <div class="table-scroll">
        <table class="table">
                ...
                <tbody>
                    <tr>
                        <td style="vertical-align: middle;"><pre class="variables highlight"><code class="scss">$modal-enable-css: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables the css close functionality of the modal.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-enable-js: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables the css JS functionality of the modal.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-container-box-shadow: 
0 27px 24px 0 rgba(0, 0, 0, 0.2), 
0 40px 77px 0 rgba(0, 0, 0, 0.22);</code></pre></td>
                        <td>Color</td>
                        <td>The box shadow around the modal container.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-container-border-radius: 6px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Borer radius of the modal container.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-container-small-width: 500px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Default modal width in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-container-large-width: 700px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Default large modal width in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-container-transform: -50px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>How much the modal container should animate down (or up) from, in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-close-button-color: rgba(0, 0, 0, 0.4);</code></pre></td>
                        <td>Color</td>
                        <td>The color of the cross that appears in the top right hand side of the modal.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-mobile-padding: 25px 15px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount on mobile devices for the modal container in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-default-padding: 75px 0;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount on large devices (tablet and upwards) for the modal container in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-header-padding: 24px 24px 0;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount for the header section of the modal (top) in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-body-padding: 24px 24px 16px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount for the body section of the modal (middle) in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-footer-padding: 0 24px 24px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount for the footer section of the modal (bottom) in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-overlay-background-color: rgba(0, 0, 0, 0.4);</code></pre></td>
                        <td>Color</td>
                        <td>Default color of the modal overlay (full width, full height).</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-container-transition: 0.4s;</code></pre></td>
                        <td>Seconds | milliseconds</td>
                        <td>The amount in seconds/milliseconds it takes for the modal container to appear.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$modal-overlay-transition: 0.6s;</code></pre></td>
                        <td>Seconds | milliseconds</td>
