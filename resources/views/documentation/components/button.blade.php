...
<article class="section-scroll" id="variables">
    ...
    <div class="table-scroll">
        <table class="table">
                ...
                <tbody>
                    <tr>
                        <td style="vertical-align: middle;"><pre class="variables highlight"><code class="scss">$button-enable-colored: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables the default colored mesh buttons.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-disabled: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables the disabled button.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-outline: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables the outlined button.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-sizes: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables large & small buttons.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-rounded: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables rounded buttons.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-icons: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables icons and just icon buttons.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-block: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables block buttons (width 100%).</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-loading: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables loading buttons (spinners).</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-enable-shadows: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables shadows for buttons in their normal state and hover.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-padding-small: 8px 20px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount for small sized buttons in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-padding-medium: 14px 30px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount for medium sized buttons in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-padding-large: 20px 40px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Padding amount for large sized buttons in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$button-padding-round: 14px 40px;</code></pre></td>
                        <td>Pixel/em/rem</td>
