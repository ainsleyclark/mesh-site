...
<article class="section-scroll" id="arrows">
    ...
    <p class="secondary-lead">
        You can also change the default slashes to arrows by adding the <code class="inline">breadcrumb-arrow</code>
        class to the parent, in conjunction with <code class="inline">breadcrumb</code>.
    </p>
    ...
    <pre
        class="highlight"><code class="html">&lt;ul class="breadcrumb breadcrumb-arrow bg-primary c-white"&gt;
    &lt;li class="breadcrumb-item"&gt;&lt;a href="#"&gt;Nav item&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item"&gt;&lt;a href="#"&gt;Nav item&lt;/a&gt;&lt;/li&gt;
    &lt;li class="breadcrumb-item active"&gt;&lt;a href="#"&gt;Active nav item&lt;/a&gt;&lt;/li&gt;
&lt;/ul&gt;</code><img class="copy-to-clipboard"src="/assets/icons/copy.svg" alt="Copy icon"><img class="copy-tick"src="/assets/icons/checked.svg" alt="Success icon"></pre>
            ...
            <tbody>
                <tr>
                    <td style="vertical-align: middle;">
                        <pre
                            class="variables highlight"><code class="scss">$breadcrumb-active-color: rgba(0, 0, 0, 0.5);</code></pre>
                    </td>
                    <td>Color</td>
