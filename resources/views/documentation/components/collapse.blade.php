...
<article class="section-scroll" id="usage">
    ...
    <p class="secondary-lead">
        We understand collapsiable content is some what difficult with pure CSS. Animating the max-height property with CSS alone doesnt allow for a smooth transition between each accordion, which is why we have included a CSS & JS version shown below.
        <br>We have provided the CSS so choose one of the options below or implement your own! 
    </p>
    <div class="text-cont">
        <h3>Notation:</h3>
        <ul class="list-line">
            <li>The contianer of the items should be prefixed with <code class="inline">collapse</code> and use the <code class="inline">collapse-css</code> for CSS close functionality (show below).</li>
            <li>Items should be tagged with the <code class="inline">collapse-item</code> class.</li>
            <li>The <code class="inline">collapse-header</code> is the wrapper for the visible content (text and icon).</li>
            <li>The <code class="inline">collapse-content</code> is the unseen content and will become visible when the user clicks the header.</li>
        </ul>
    </div>
    <div class="text-cont">
        <h3>Example:</h3>
        <p>Here we are using the checkbox trick to display the collapsible content.
            <br><strong>Note:</strong> If using this technique ensure the checkbox id matches the label <code class="inline">for</code> attribute.
        </p>
    </div>
    ...
    <pre class="highlight mt-5"><code class="html">&lt;div class=&quot;collapse collapse-css&quot;&gt;
    &lt;div class=&quot;collapse-item&quot;&gt;
        &lt;input type=&quot;checkbox&quot; class=&quot;collapse-toggle&quot; id=&quot;collapse1&quot;&gt;
        &lt;label class=&quot;collapse-header&quot; for=&quot;collapse1&quot; tabindex=&quot;1&quot;&gt;
            &lt;span class=&quot;collapse-title&quot;&gt;Collapsible item no 1.&lt;/span&gt;
...
<article class="section-scroll" id="accordion">
    ...
    <p class="secondary-lead">
        Accordions provide a way of expanding only one section of content at a time, great for large sections of content. Click the header item to watch it expand.
    </p>
    <div class="text-cont">
        <h3>Notation:</h3>
        <ul class="list-line">
            <li>If you wish to use our JS code at the bottom of the page, make sure you wrap your content with a <code class="inline">collapse-inner</code> class inside the <code class="inline">collapse-content</code> div.</li>
            <li>Add the <code class="inline">collapse-js</code> class alongside the <code class="inline">collapse</code> element, to enable transition & styling.</li>
            <li>Wrap the whole collapse inside a div and call it what ever you fancy, we will show you how soon.</li>
        </ul>
    </div>
    <div class="accordion">
    ...
    <div class="text-cont mt-5">
        <h3>JS:</h3>
        <p>If using our JS code mentioned below, you can create a new accordion by creating a new Collapse object, setting the parent (in our case <code class="inline">accordion</code>) and then addding an accordion property set to true.</p>
    </div>
    <pre class="highlight"><code class="js">let accordion = new Collapse({
    accordion: true,
    parent: document.body.querySelector('.accordion')
    ...
    <pre class="highlight"><code class="js">&lt;div class=&quot;accordion&quot;&gt;
    &lt;div class=&quot;collapse collapse-js&quot;&gt;
        &lt;div class=&quot;collapse-item&quot;&gt;
            &lt;label class=&quot;collapse-header&quot;&gt;
                &lt;span class=&quot;collapse-title&quot;&gt;Collapsible item no 1.&lt;/span&gt;
...
<article class="section-scroll" id="expand">
    ...
    <p class="secondary-lead">
        In order for the content to stay expanded when you click a collapsible item, just rid of the accordion property in the JS. Go ahead a click the collapse items to see the effect.
    </p>
    ...
    <div class="text-cont mt-5">
        <h3>JS:</h3>
        <p>If using our JS code mentioned below, you can create a new accordion by creating a new Collapse object, setting the parent (in our case <code class="inline">expand</code>) like below.</p>
    </div>

    <pre class="highlight"><code class="js">let collapse = new Collapse({
    parent: document.body.querySelector('.expand')
});</code><img class="copy-to-clipboard" src="/assets/icons/copy.svg" alt="Copy icon"><img class="copy-tick"src="/assets/icons/checked.svg" alt="Success icon"></pre>
    <div class="text-cont">
        <h3>Markup:</h3>
    </div>
    <pre class="highlight"><code class="js">&lt;div class=&quot;expand&quot;&gt;
    &lt;div class=&quot;collapse collapse-js&quot;&gt;
        &lt;div class=&quot;collapse-item&quot;&gt;
            &lt;label class=&quot;collapse-header&quot;&gt;
                &lt;span class=&quot;collapse-title&quot;&gt;Collapsible item no 1.&lt;/span&gt;
...
<article class="section-scroll" id="js">
    ...
    <pre class="highlight mt-4"><code class="js">function Collapse(options) {
    let defaultOpt = {
        parent: document.body,
        accordion: false,
        outer: '.collapse-js',
...
<article class="section-scroll" id="variables">
    ...
    <div class="table-scroll">
        <table class="table">
                ...
                <tbody>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$collapse-enable-css-close: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables the css close functionality of the collapsible content.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$collapse-enable-js-close: true;</code></pre></td>
                        <td>Boolean</td>
                        <td>Enables/disables the JS close functionality of the collapsible content.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$collapse-header-padding: 25px 10px 5px 0;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Header collapse padding (visible) in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$collapse-content-padding: 15px 15px 20px; </code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>Content collapse padding (invisible) in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$collapse-title-margin-top: 10px;</code></pre></td>
                        <td>Pixel/em/rem</td>
                        <td>The margin top of the title in pixels, em's or rem's.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$collapse-active-color: color('secondary');</code></pre></td>
                        <td>Color</td>
                        <td>This is the default color of the active collapsiable content, here we are using the secondary color from the mesh color palette.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight">$collapse-border: 1px solid #ddd;<code class="scss"></code></pre></td>
                        <td>CSS border</td>
