...
<article class="section-scroll" id="usage">
    ...
    <p class="secondary-lead">
        Things can get complicated when trying to position elements with CSS, which is why we have created handy utility
        classes to help you along your way. For more information on the position property, head over to <a
    ...
    <div class="text-cont">
        <h3>Notation:</h3>
        <ul class="list-line">
            <li>You can target the position class by using <code class="inline">p-{breakpoint}-{property}</code>. The
                breakpoint being optional and one of our five breakpoints, the properties being outlined below.</li>
            <li>As mesh is mobile first, these classes affect the breakpoint and upwards, for example - <code
                    class="inline">p-tab-absolute</code> will make the element's position absolute on tablet, desktop &
                HD screens.</li>
        </ul>
    </div>
    <div class="text-cont">
...
<article class="section-scroll" id="pinning">
    ...
    <p>You can also use the <code class="inline">pin</code> classes to fix elements to the top, right, bottom & left of
        the container/parent, see below:</p>
    <table class="table-code w-100 t-left">
        <col width="100">
        <col width="100">
        <thead>
...
<article class="section-scroll" id="examples">
    ...
    <p>
        Here, the purple element, the third that sits in the DOM will be positioned absolutely from desktop widths and
        above, whilst being static at mobile and tablet.
    </p>
    <div class="column-demo c-white mb-3">
        <div
            class="br d-flex mb-3 height-100 bg-light justify-content-center align-items-center justify-content-desk-between t-center">
            <div class="text px-3 mx-2 br mx-0 w-30"></div>
            <div class="text px-3 mx-2 br mx-0 w-30"></div>
            <div class="text px-3 mx-2 br mx-0 w-30 p-desk-absolute bg-secondary" style="opacity: 0.6; left: 20%;">
            </div>
        </div>
    </div>
    <pre
...
<article class="section-scroll" id="variables">
    ...
    <div class="table-scroll">
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td>
                        <pre class="variables highlight"><code class="scss">$position-properties: (
    relative, 
    absolute, 
    fixed, 
    static, 
    sticky
                    ...
                    <td>Map(property)</td>
                    <td>To remove position paramters just delete from the map above, this will in turn delete the class
                        and responsive class associated with the property, e.g. <code class="inline">p-mob-sticky</code>
                    </td>
                </tr>
            </tbody>
        </table>
