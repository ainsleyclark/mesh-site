...
<!-- =====================
    ...
    ===================== -->
<script src="{{ asset('js/docs/grid.js') }}"></script>
@endpush
...
<article class="section-scroll" id="variables">
    ...
    <p class="secondary-lead">
        You can manipulate thg grids columns, breakpoints and gap widths using the variables below.
    </p>
    <div class="table-scroll">
        <table class="table">
                ...
                <tbody>
                    <tr>
                        <td style="vertical-align: middle;"><pre class="variables highlight"><code class="scss">$grid-columns: 12 !default;</code></pre></td>
                        <td>Number</td>
                        <td>The amount of columns in the grid.</td>
                    </tr>
                    <tr>
                        <td><pre class="variables highlight"><code class="scss">$gap-width: 15px !default;</code></pre></td>
                        <td>Pixels</td>
...
$grid-breakpoint-hd: 1408 !default;</code></pre>
        ...
        '-hd': $grid-breakpoint-hd
                        ...
                        <td>Defines the grid breakpoint class values, add and delete, ensure the variable corrosponds to the breakpoint variable above.</td>
                    </tr>
                </tbody>
            </table>
        </div>
